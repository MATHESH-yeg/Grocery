...
const Home = () => {
  ...
  return (
    <div className="container-responsive space-y-12">
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">New products with updated stocks.</p>
          </div>
          <Link to="/products" className="text-sm font-medium text-gray-500 hover:text-primary flex items-center gap-1">
            View All
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {categories.map((cat, idx) => (
            ...
            >
              ...
              <span className="text-xs font-semibold text-gray-700 text-center group-hover:text-primary leading-tight">
                {cat.name}
              </span>
            </Link>
          ))}
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-gray-800">Fresh from the Harvest</h2>
        </div>
        {loading ? (
